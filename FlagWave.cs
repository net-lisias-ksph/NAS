...
namespace AntiSubmarineWeapon
{
    class FlagWave : PartModule
    {
        ...
        public override void OnUpdate()
        {
            ...
            if (HighLogic.LoadedSceneIsFlight)
            {
                Wave(flagVertex1, flag1.GetComponent<MeshFilter>(), flag1.GetInstanceID());
                Wave(flagmVertex1, flagm1.GetComponent<MeshFilter>(), flag1.GetInstanceID());
                Wave(flagVertex2, flag2.GetComponent<MeshFilter>(), flag1.GetInstanceID());
                WaveT(flagmVertex2, flagm2.GetComponent<MeshFilter>(), flag1.GetInstanceID());
            }
        }
    }
}
